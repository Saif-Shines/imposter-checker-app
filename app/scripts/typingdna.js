...
function TypingDNA() {
  if (TypingDNA.initialized !== true) {
    ...
    (TypingDNA.ua = window.navigator.userAgent), (TypingDNA.platform =
    ...
    TypingDNA.keyDown = function(e) {
      ...
      if (
        TypingDNA.recording === true ||
        (TypingDNA.spKeyCodesObj[keyCode] && TypingDNA.spKeyRecording === true)
      ) {
        if (!e.shiftKey) {
    ...
    TypingDNA.keyUp = function(e) {
      ...
      if (TypingDNA.diagramRecording === true) {
        if (
          TypingDNA.drkc[keyCode] !== undefined &&
          TypingDNA.drkc[keyCode] !== 0
        ) {
    ...
    TypingDNA.AndroidKeyUp = function(e) {
      ...
      if (
        ...
        TypingDNA.ACInputLengths.lastLength[targetIndex]
      ) {
      ...
      if (TypingDNA.mouseRecording === true) {
        if (TypingDNA.mouseMoveRecording === true) {
          if (TypingDNA.mouse.scrollStarted === true) {
            ...
            TypingDNA.mouse.scrollTopArr.push(
              TypingDNA.document.body.scrollTop
            );
            clearInterval(TypingDNA.scrollInterval);
            TypingDNA.scrollInterval = setInterval(
              TypingDNA.mouse.checkScroll,
              TypingDNA.maxScrollDeltaTime
            );
          } else {
      ...
      if (TypingDNA.mouseRecording === true) {
        ...
        if (TypingDNA.mouseMoveRecording === true) {
          if (TypingDNA.mouse.started === true) {
            ...
            TypingDNA.moveInterval = setInterval(
              TypingDNA.mouse.checkMove,
              TypingDNA.maxMoveDeltaTime
            );
          } else {
    ...
    TypingDNA.mouseDown = function(e) {
      if (TypingDNA.mouseRecording === true) {
        ...
        if (e.which === 1) {
          ...
          var stopTime =
            TypingDNA.lastMouseDownTime - TypingDNA.lastMouseMoveTime;
          if (
            stopTime < TypingDNA.maxStopTime &&
            TypingDNA.lastMouseStop === false
          ) {
    ...
    TypingDNA.deviceMotionHandler = function(e) {
      ...
      TypingDNA.kpLastPitch = Math.floor(
        Math.atan2(
          -kpCurAccY,
          Math.sqrt(Math.pow(kpCurAccX, 2) + Math.pow(kpCurAccZ, 2))
        ) *
          180 /
          Math.PI *
          10
      );
      TypingDNA.kpLastRoll = Math.floor(
        Math.atan2(
          -kpCurAccX,
          Math.sqrt(Math.pow(kpCurAccY, 2) + Math.pow(kpCurAccZ, 2))
        ) *
          180 /
          Math.PI *
          10
    ...
    if (TypingDNA.isMobile() === 1) {
      if (TypingDNA.isAndroid()) {
        if (TypingDNA.isFirefox()) {
          ...
          TypingDNA.document.addEventListener(
            'keydown',
            TypingDNA.AndroidKeyDown
          );
        } else {
    ...
    TypingDNA.kpGetAll = function() {
      ...
      if (TypingDNA.kpAccZ.length < 2) {
        returnVal =
          TypingDNA.hasDeviceMotion && TypingDNA.hasDeviceOrientation
            ? 0
            : TypingDNA.lastPressTime;
        returnMotion = [
          0,
          0,
          0,
          ...
          0,
          0,
          TypingDNA.kpLastPitch,
          TypingDNA.kpLastRoll
        ];
        return [returnVal, returnMotion, [0], [0], [0]];
      } else {
        ...
        returnMotion = [
          TypingDNA.kpLastAccX,
          TypingDNA.kpLastAccY,
          TypingDNA.kpAccZ.pop(),
          TypingDNA.kpX.pop(),
          TypingDNA.kpY.pop(),
          TypingDNA.kpLastZ,
          TypingDNA.kpLastPitch,
      ...
      if (leftRight) {
        if (downUp) {
          angle =
            ...
            Math.round(
              Math.atan(
                Math.abs(xPosDelta) / (Math.abs(yPosDelta) + 0.0000001)
              ) / 0.01745329251
        ...
        if (downUp) {
          ...
          angle = Math.round(
            Math.atan(Math.abs(xPosDelta) / (Math.abs(yPosDelta) + 0.0000001)) /
              0.01745329251
          );
        }
      }
    ...
    TypingDNA.mouse.recordMoveAction = function(drag) {
      ...
      var deltaTime =
        TypingDNA.mouse.times[length - 1] - TypingDNA.mouse.times[0];
      var xPosDelta =
        TypingDNA.mouse.xPositions[length - 1] - TypingDNA.mouse.xPositions[0];
      var yPosDelta =
        TypingDNA.mouse.yPositions[length - 1] - TypingDNA.mouse.yPositions[0];
      var directDistance = Math.round(
        TypingDNA.mouse.getDistance(xPosDelta, yPosDelta)
      );
      var totalDistance = Math.round(
        TypingDNA.mouse.getTotalDistance(
          TypingDNA.mouse.xPositions,
          TypingDNA.mouse.yPositions
        )
      );
    ...
    TypingDNA.mouse.recordScrollAction = function() {
      ...
      var deltaTime =
        TypingDNA.mouse.scrollTimes[length - 1] -
        TypingDNA.mouse.scrollTimes[0];
      var directDistance =
        TypingDNA.mouse.scrollTopArr[length - 1] -
        TypingDNA.mouse.scrollTopArr[0];
      var speed = Math.round(directDistance * 100 / deltaTime);
      var eventType = 2;
    ...
    TypingDNA.mouse.history.getDiagram = function() {
      ...
      return [
        String(TypingDNA.isMobile()) +
          ',' +
          String(TypingDNA.version) +
          ',' +
          TypingDNA.flags +
          ',' +
          diagramType +
          ',0,0,' +
          TypingDNA.getSpecialKeys() +
          ',' +
          TypingDNA.getDeviceSignature(),
        mouseDiagram
      ].join('|');
    };
    ...
    TypingDNA.get = function(length, targetId) {
      ...
      var zl = TypingDNA.zl;
      var histRev = length;
      var histSktF = TypingDNA.math.fo(
        TypingDNA.history.get(length, 'seek', targetId)
      );
      var histPrtF = TypingDNA.math.fo(
        TypingDNA.history.get(length, 'press', targetId)
      );
      ...
      var pressRatio = TypingDNA.math.rd(
        (pressHistMean + zl) / (charMeanTime + zl),
        4
      );
      var seekToPressRatio = TypingDNA.math.rd(
        (1 - pressRatio) / pressRatio,
        4
      );
      var pressSDToPressRatio = TypingDNA.math.rd(
        (pressHistSD + zl) / (pressHistMean + zl),
        4
      );
      var seekSDToPressRatio = TypingDNA.math.rd(
        (seekHistSD + zl) / (pressHistMean + zl),
        4
      );
      ...
      for (var i in obj.arr) {
        ...
        switch (obj.arr[i][0].length) {
          case 0:
            break;
          case 1:
            seekMean = TypingDNA.math.rd(
              (obj.arr[i][0][0] + zl) / (seekHistMean + zl),
              4
            );
            break;
          default:
            ...
            seekMean = TypingDNA.math.rd(
              (TypingDNA.math.avg(arr) + zl) / (seekHistMean + zl),
              4
            );
            seekSD = TypingDNA.math.rd(
              (TypingDNA.math.sd(arr) + zl) / (seekHistSD + zl),
              4
            );
        }
        switch (obj.arr[i][1].length) {
          case 0:
            break;
          case 1:
            pressMean = TypingDNA.math.rd(
              (obj.arr[i][1][0] + zl) / (pressHistMean + zl),
              4
            );
            break;
          default:
            ...
            pressMean = TypingDNA.math.rd(
              (TypingDNA.math.avg(arr) + zl) / (pressHistMean + zl),
              4
            );
            pressSD = TypingDNA.math.rd(
              (TypingDNA.math.sd(arr) + zl) / (pressHistSD + zl),
              4
            );
        }
        switch (obj.arr[i][2].length) {
          case 0:
            break;
          case 1:
            postMean = TypingDNA.math.rd(
              (obj.arr[i][2][0] + zl) / (seekHistMean + zl),
              4
            );
            break;
          default:
    ...
    TypingDNA.history.getDiagram = function(
      extended,
      str,
      textId,
      targetId,
      ...
      if (
        ...
        if (str === undefined || str === '') {
          if (targetLength > 0) {
            str = '';
            for (var i = 0; i < targetLength; i++) {
              element = TypingDNA.document.getElementById(
                TypingDNA.targetIds[i]
              );
              if (element != null) {
                str += element.value;
              }
            ...
            if (!extended) {
              console.log(
                'Please provide a fixed string param OR use the addTarget method.'
              );
            }
          }
        }
      ...
      if (str !== undefined && str.length > 0 && typeof str === 'string') {
        ...
        for (i = 0; i < str.length; i++) {
          ...
          if (!caseSensitive) {
            ...
            currentSensitiveCharCode =
              strUpperCharCode !== currentCharCode
                ? strUpperCharCode
                : strLower.charCodeAt(i);
          }
          ...
          while (found === false) {
            for (var j = startPos; j < finishPos; j++) {
              ...
              if (
                ...
                (!caseSensitive && charCode === currentSensitiveCharCode)
              ) {
                found = true;
                if (j === lastPos) {
                  lastPos++;
                  ...
                  if (
                    len > 1 &&
                    lastFoundPos[len - 1] === lastFoundPos[len - 2] + 1
                  ) {
                    lastPos = j + 1;
                    lastFoundPos = [];
                  }
                ...
                if (
                  ...
                  if (
                    TypingDNA.hasDeviceMotion &&
                    TypingDNA.hasDeviceOrientation
                  ) {
            ...
            if (found === false) {
              if (startPos !== 0) {
                ...
                if (TypingDNA.replaceMissingKeys) {
                  missingCount++;
                  if (
                    typeof TypingDNA.savedMissingAvgValues !== 'object' ||
                    TypingDNA.savedMissingAvgValues.historyLength !==
                      diagramHistoryLength
                  ) {
                    var histSktF = TypingDNA.math.fo(
                      TypingDNA.history.get(0, 'seek')
                    );
                    var histPrtF = TypingDNA.math.fo(
                      TypingDNA.history.get(0, 'press')
                    );
          ...
          if (
            TypingDNA.replaceMissingKeysPerc <
            missingCount * 100 / strLength
          ) {
            return null;
          }
        }
    ...
    TypingDNA.getOSBrowserMobile = function() {
      ...
      if ((mobile !== 3 || mobile === 2) && TypingDNA.isMobile() === 1) {
        if (
          ...
          (os === 6 || os === 0) &&
          ((orientation && screen.height > 767 && screen.width > 480) ||
    ...
    TypingDNA.getDeviceSignature = function() {
      ...
      var signature = TypingDNA.math.fnv1aHash(
        [
          deviceType,
          deviceModel,
          deviceId,
    ...
    TypingDNA.getLength = function(typingPattern) {
      if (typingPattern && typeof typingPattern === 'string') {
        ...
        if (separatorIndex > 0) {
          return (
            Number(typingPattern.substring(0, separatorIndex).split(',')[4]) ||
            0
          );
        } else {
